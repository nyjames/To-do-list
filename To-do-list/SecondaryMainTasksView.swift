//
//  SecondaryMainTasksView.swift
//  To-do-list
//
//  Created by Nya James on 5/12/25.
//

import SwiftUI
import SwiftData

struct SecondaryMainTasksView: View {
    ...
    var body: some View {
        ...
        NavigationStack {
            ...
            .searchable(text: $searchQuery, prompt: "Search For Tasks")
